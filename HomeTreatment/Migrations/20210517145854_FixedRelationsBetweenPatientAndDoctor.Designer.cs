...
namespace HomeTreatment.Migrations
{
    ...
    [Migration("20210517145854_FixedRelationsBetweenPatientAndDoctor")]
    partial class FixedRelationsBetweenPatientAndDoctor
    {
            ...
            modelBuilder.Entity("HomeTreatment.Data.Models.Patient", b =>
                {
                    b.HasOne("HomeTreatment.Data.User", "User")
                        .WithOne("Patient")
                        .HasForeignKey("HomeTreatment.Data.Models.Patient", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
